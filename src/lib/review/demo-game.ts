...
export const blackburneShillingTrapGame: ReviewGameSeed = {
  ...
  moves: [
    ...
    },
    {
      ...
      evalScore: -9.2,
      learningCategory: "🛡️ Defensive Priority",
    },
    {
      san: "Qxe4+",
      classification: "best",
...
export const operaGame: ReviewGameSeed = {
  ...
  moves: [
    ...
    { san: "Nf6", classification: "good", explanation: "Defends against immediate mate on f7.", evalScore: 2.5, learningCategory: "🛡️ Defensive Priority" },
    ...
    { san: "Qe7", classification: "good", explanation: "Defends f7 while leaving b7 vulnerable.", evalScore: 3.2, learningCategory: "🛡️ Defensive Priority" },
    ...
    { san: "c6", classification: "good", explanation: "Defends b5 square and protects b7 pawn.", evalScore: 3.6, learningCategory: "🛡️ Defensive Priority" },
    ...
    { san: "cxb5", classification: "good", explanation: "Accepts the sacrifice, but opens the a-file for White.", evalScore: 7.5, learningCategory: "🛡️ Defensive Priority" },
    ...
    { san: "Nbd7", classification: "good", explanation: "Blocks the check, but Black is heavily pinned.", evalScore: 8.2, learningCategory: "🛡️ Defensive Priority" },
    ...
    { san: "Rd8", classification: "good", explanation: "Attempts to reinforce the pinned knight on d7.", evalScore: 8.8, learningCategory: "🛡️ Defensive Priority" },
    ...
    { san: "Rxd7", classification: "good", explanation: "Recaptures with rook.", evalScore: 9.8, learningCategory: "🛡️ Defensive Priority" },
    ...
    { san: "Nxd7", classification: "good", explanation: "Recaptures with knight.", evalScore: 10.0, isMate: true, learningCategory: "🛡️ Defensive Priority" },
    ...
    { san: "Nxb8", classification: "good", explanation: "Forced capture of the queen.", evalScore: 10.0, isMate: true, learningCategory: "🛡️ Defensive Priority" },
